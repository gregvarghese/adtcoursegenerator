        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <x-nav-dropdown title="Apps" align="right" width="48">
                        ...
                        <x-dropdown-link href="{{ route('topics.index') }}">
                        Topics
                        </x-dropdown-link>
                        @endcan
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
                ...
                @endcan
                @can('view-any', App\Models\Section::class)
                <x-responsive-nav-link href="{{ route('sections.index') }}">
                Sections
                </x-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Topic::class)
                <x-responsive-nav-link href="{{ route('topics.index') }}">
                Topics
                </x-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\History::class)
                <x-responsive-nav-link href="{{ route('histories.index') }}">
                Histories
                </x-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\User::class)
